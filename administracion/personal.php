...
<head>
   ...
   <meta charset="utf-8">
    ...
    <title>Profesionales Gastroquirurgica</title>
    <?php
session_start();
...
<div class="col-sm-12 text-right mb-3">
                  <a class="btn btn-primary" href="registrar_profesional.php">Agregar Profesional</a>
              </div>
            <div class="col-sm-12 card shadow mb-3">
<div class="card-header py-3">
<h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-address-book-o"></i> Personal</h6>
            </div>
...
<table id="minhatabela" class="display responsive table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                ...
                <tbody> 
                    ...
                    <tr>
                        ...
                        <?php $cargo = $profesional->Obtener_Cargo_profesional($row['documento']); ?>
                        <td class="text-center"><?php echo $cargo[0]; ?></td>
                        <?php $estado = $profesional->Obtener_Estado_profesional($row['documento']); ?>
